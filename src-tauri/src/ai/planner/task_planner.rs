...
pub fn tool_call_to_task(tool_call: &ToolCall) -> Result<Option<Task>, String> {
    ...
    match tool_call.name.as_str() {
        ...
        "place_block" => {
            ...
            let y = args["y"].as_i64().ok_or("Missing y")? as i32;
            let z = args["z"].as_i64().ok_or("Missing z")? as i32;
            Ok(Some(Task::Place { block, x, y, z }))
        }
        "build_structure" => {
